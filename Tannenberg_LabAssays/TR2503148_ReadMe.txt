...
CERTIFICATE DETAILS
-------------------
  Certificate No : TR2503148
  Batch          : 1.2
  Samples received at lab : 23-Dec-25
  Results reported        : 06-Feb-26
  Total samples           : 151
  Output file             : TR2503148_BHP.csv

SOURCE FILE STRUCTURE
---------------------
The original TR2503148.CSV had an 8-row non-standard header before any data:
...
OUTPUT FILE STRUCTURE (TR2503148_BHP.csv)
---------------------------------------
...
---------------------
  ...
  CertificateNo : TR2503148
  Received      : 23-Dec-25
  Reported      : 06-Feb-26
  SAMPLEID      : Lab sample identifier (e.g. PAL00721)
  SAMPLETYPE    : Core
