...
CERTIFICATE DETAILS
-------------------
  Certificate No : TR2503147
  Batch          : 1.2
  Samples received at lab : 26-Dec-25
  Results reported        : 06-Feb-26
  Total samples           : 149
  Output file             : TR2503147_BHP.csv

SOURCE FILE STRUCTURE
---------------------
The original TR2503147.CSV had an 8-row non-standard header before any data:
...
OUTPUT FILE STRUCTURE (TR2503147_BHP.csv)
---------------------------------------
...
---------------------
  ...
  CertificateNo : TR2503147
  Received      : 26-Dec-25
  Reported      : 06-Feb-26
  SAMPLEID      : Lab sample identifier (e.g. PAL00601)
  SAMPLETYPE    : Core
  SapSubType    : Drill Core
  Point_Type    : Drillhole
  Dsptch_L_D    : Full batch ID string from Row 1
  SmpDspDate    : 26-Dec-25
