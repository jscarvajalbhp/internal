...
CERTIFICATE DETAILS
-------------------
  Certificate No : TR2503152
  Batch          : 1.2
  Samples received at lab : 24-Dec-25
  Results reported        : 06-Feb-26
  Total samples           : 105
  Output file             : TR2503152_BHP.csv

SOURCE FILE STRUCTURE
---------------------
The original TR2503152.CSV had an 8-row non-standard header before any data:
...
OUTPUT FILE STRUCTURE (TR2503152_BHP.csv)
---------------------------------------
...
---------------------
  ...
  CertificateNo : TR2503152
  Received      : 24-Dec-25
  Reported      : 06-Feb-26
  SAMPLEID      : Lab sample identifier (e.g. PAL01201)
  SAMPLETYPE    : Core
