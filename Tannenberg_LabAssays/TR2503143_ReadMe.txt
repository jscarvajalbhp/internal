...
CERTIFICATE DETAILS
-------------------
  Certificate No : TR2503143
  Batch          : 1.2
  Samples received at lab : 19-Dec-25
  Results reported        : 06-Feb-26
  Total samples           : 152
  Output file             : TR2503143_BHP.csv

SOURCE FILE STRUCTURE
---------------------
The original TR2503143.CSV had an 8-row non-standard header before any data:
...
OUTPUT FILE STRUCTURE (TR2503143_BHP.csv)
---------------------------------------
...
---------------------
  ...
  CertificateNo : TR2503143
  Received      : 19-Dec-25
  Reported      : 06-Feb-26
  SAMPLEID      : Lab sample identifier (e.g. PAL00121)
  SAMPLETYPE    : Core
