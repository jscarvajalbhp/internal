================================================================================
  README - Certificate TR2502684
  Project: Tannenberg Copper Project
  BHP Drilling-Assays Schema | Batch 1.1
  Date processed: 2026-07-17
================================================================================

CERTIFICATE DETAILS
-------------------
  Certificate No : TR2502684
  Batch          : 1.1
  Samples received at lab : 08-Nov-25
  Results reported        : 14-Nov-25
  Total samples           : 133
  Output file             : TR2502684_BHP.csv

SOURCE FILE STRUCTURE
---------------------
The original TR2502684.CSV had an 8-row non-standard header before any data:
...
OUTPUT FILE STRUCTURE (TR2502684_BHP.csv)
---------------------------------------
...
---------------------
  ...
  CertificateNo : TR2502684
  Received      : 08-Nov-25
  Reported      : 14-Nov-25
  SAMPLEID      : Lab sample identifier (e.g. PAL01284)
  SAMPLETYPE    : Core
