...
CERTIFICATE DETAILS
-------------------
  Certificate No : TR2503150
  Batch          : 1.2
  Samples received at lab : 24-Dec-25
  Results reported        : 06-Feb-26
  Total samples           : 151
  Output file             : TR2503150_BHP.csv

SOURCE FILE STRUCTURE
---------------------
The original TR2503150.CSV had an 8-row non-standard header before any data:
...
OUTPUT FILE STRUCTURE (TR2503150_BHP.csv)
---------------------------------------
...
---------------------
  ...
  CertificateNo : TR2503150
  Received      : 24-Dec-25
  Reported      : 06-Feb-26
  SAMPLEID      : Lab sample identifier (e.g. PAL00961)
  SAMPLETYPE    : Core
  SapSubType    : Drill Core
  Point_Type    : Drillhole
  Dsptch_L_D    : Full batch ID string from Row 1
  SmpDspDate    : 24-Dec-25
