...
CERTIFICATE DETAILS
-------------------
  Certificate No : TR2503145
  Batch          : 1.2
  Samples received at lab : 22-Dec-25
  Results reported        : 06-Feb-26
  Total samples           : 149
  Output file             : TR2503145_BHP.csv

SOURCE FILE STRUCTURE
---------------------
The original TR2503145.CSV had an 8-row non-standard header before any data:
...
OUTPUT FILE STRUCTURE (TR2503145_BHP.csv)
---------------------------------------
...
---------------------
  ...
  CertificateNo : TR2503145
  Received      : 22-Dec-25
  Reported      : 06-Feb-26
  SAMPLEID      : Lab sample identifier (e.g. PAL00361)
  SAMPLETYPE    : Core
