...
CERTIFICATE DETAILS
-------------------
  Certificate No : TR2502686
  Batch          : 1.1
  Samples received at lab : 08-Nov-25
  Results reported        : 14-Nov-25
  Total samples           : 130
  Output file             : TR2502686_BHP.csv

SOURCE FILE STRUCTURE
---------------------
The original TR2502686.CSV had an 8-row non-standard header before any data:
...
OUTPUT FILE STRUCTURE (TR2502686_BHP.csv)
---------------------------------------
...
---------------------
  ...
  CertificateNo : TR2502686
  Received      : 08-Nov-25
  Reported      : 14-Nov-25
  SAMPLEID      : Lab sample identifier (e.g. PAL01484)
  SAMPLETYPE    : Core
