...
CERTIFICATE DETAILS
-------------------
  Certificate No : TR2503142
  Batch          : 1.2
  Samples received at lab : 19-Dec-25
  Results reported        : 06-Feb-26
  Total samples           : 153
  Output file             : TR2503142_BHP.csv

SOURCE FILE STRUCTURE
---------------------
The original TR2503142.CSV had an 8-row non-standard header before any data:
...
OUTPUT FILE STRUCTURE (TR2503142_BHP.csv)
---------------------------------------
...
---------------------
  ...
  CertificateNo : TR2503142
  Received      : 19-Dec-25
  Reported      : 06-Feb-26
  SAMPLEID      : Lab sample identifier (e.g. PAL00001)
  SAMPLETYPE    : Core
  SapSubType    : Drill Core
  Point_Type    : Drillhole
  Dsptch_L_D    : Full batch ID string from Row 1
  SmpDspDate    : 19-Dec-25
