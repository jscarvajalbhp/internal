...
CERTIFICATE DETAILS
-------------------
  Certificate No : TR2503144
  Batch          : 1.2
  Samples received at lab : 22-Dec-25
  Results reported        : 06-Feb-26
  Total samples           : 143
  Output file             : TR2503144_BHP.csv

SOURCE FILE STRUCTURE
---------------------
The original TR2503144.CSV had an 8-row non-standard header before any data:
...
OUTPUT FILE STRUCTURE (TR2503144_BHP.csv)
---------------------------------------
...
---------------------
  ...
  CertificateNo : TR2503144
  Received      : 22-Dec-25
  Reported      : 06-Feb-26
  SAMPLEID      : Lab sample identifier (e.g. PAL00241)
  SAMPLETYPE    : Core
  SapSubType    : Drill Core
  Point_Type    : Drillhole
  Dsptch_L_D    : Full batch ID string from Row 1
  SmpDspDate    : 22-Dec-25
...
Each element generates 4 fields: value | _GMD (method) | _LDD (lower det.) | _UDD (upper det.)
  ...
  ICP40B suite (multi-element ICP-OES):
    ...
    Pb_pct                         (method field: Pb_pct_GMD | limits: Pb_pct_LDD / Pb_pct_UDD)
    Zn_pct                         (method field: Zn_pct_GMD | limits: Zn_pct_LDD / Zn_pct_UDD)
